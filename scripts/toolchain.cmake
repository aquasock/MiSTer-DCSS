...
set(_arch "-mcpu=cortex-a9 -mfpu=neon -mfloat-abi=hard")
set(CMAKE_C_FLAGS_INIT   "${_arch}")
set(CMAKE_CXX_FLAGS_INIT "${_arch}")
set(CMAKE_FIND_ROOT_PATH "$ENV{DCSS_PREFIX}" /usr/arm-linux-gnueabihf)
set(CMAKE_PREFIX_PATH    "$ENV{DCSS_PREFIX}")
